...
strftime(buffer, sizeof("00:00"),"%H*%D",tick_time);
...
static void main_window_load(Window *window) {
  ...
  s_background_bitmap = gbitmap_create_with_resource(RESOURCE_ID_SPARK_ICON_2);
  ...
  //time layer
  s_time_layer = text_layer_create(GRect(15, 140, 120, 40));
